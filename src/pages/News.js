        ...
        <div className="home">
            <div className="container">
                <div className="home__content">
                    <h1>News page</h1>
                    <button className="article__btn" onClick={loadData}>Load Data</button>
                    <button className="article__btn" onClick={clearData}>Clear Data</button>
                    ...
                    {status !== NEWS_REQUEST_STATUS.ERROR ? (
                        ...
                        <>
                        <h3 className="article__error">Error</h3>
                        <button className="article__btn center" onClick={loadData}>Retry</button>
                        </>
                    )}
                </div>
            </div>
